...
def main():
    ...
    try:
        ...
        n_gpus = 1  # Set n_gpus to 1 for TPU
...
def run(
    ...
    net_g = DDP(net_g, device_ids=[rank] if device.type == "cuda" else None)
    net_d = DDP(net_d, device_ids=[rank] if device.type == "cuda" else None)
